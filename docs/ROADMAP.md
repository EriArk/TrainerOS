...
**Next visible increment:** P1 Center Party/Storage presentation and controller routes, retaining existing real backup/restore services and keeping future individual-Pokemon data in explicit development fixtures. Worlds/Multiverse and both Home/selector presentations are delivered as a transient UI foundation ([boundary](MULTIVERSE_UI.md)); real domain ownership, persistence, file linking and playable collection remain P2/P3/P4. Journey/RA and Playroom/Practice/Link Counter remain subsequent P1 slices. Trainer/account entry and isolated registration/chooser/PIN rehearsal are delivered ([boundary](TRAINER_SETUP_UI.md)); real startup gating, creation failure/loading states, owner migration and PIN enforcement remain P2 binding work. Start quick controls and confirmed Power are delivered; further Settings capabilities follow their own feature gates. Keep the completed [real Flip artwork bootstrap](ARTWORK_BOOTSTRAP.md). Limit early #57 work to runtime loading/validation needed by an actual consumer, preserving exact identities, provenance, explicit missing/fallback rules and bounded derivatives. Install/update still requires staged validation, cancellation and atomic activation. Do not start Studio or freeze its final authoring format now. The 142 unresolved forms remain explicit review work, not invented defaults. #51 sprites remain a separate optional detail/scene provider; production living Party stays late P8. #64 Home is implemented, with later in-game comparison and the real Journey consumer still open. All unfinished P1 UI flows below retain their place; no new save research is introduced.
