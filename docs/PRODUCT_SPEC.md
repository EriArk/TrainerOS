...
**P1 delivered:** the shared selector, Pokedex/Center pair and Hall/RetroAchievements pair now work on the single-Trainer baseline. [Implementation and remaining boundaries](SHARED_ADVENTURE.md). The full ownership/provider contract below remains the target.
