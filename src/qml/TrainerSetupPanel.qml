    ...
    Item {
        ...
        MountedPanel {
            ...
            Item {
                ...
                Text { y: 202; width: parent.width; text: root.flow.stage === "review" ? root.flow.pinChoice : root.flow.live ? "Shared games · Personal profile" : "Original Trainer emblem"; horizontalAlignment: Text.AlignHCenter; color: Theme.muted; font.pixelSize: 13 }
            }
            Item {
