...
Item {
    ...
    Text { x: 40; y: parent.height-37; text: root.access.canRecover ? "A  Select    X  Forgot PIN?    B  Choose another Trainer" : "A  Select    B  Back"; color: "#f6e4b3"; font.pixelSize: 17 }
